...
def print_credentials(username, password, num):

    print("\n",num,") Username is:", username, "& password is:", password)
...
if __name__ == '__main__':
    ...
    fprofiles       = open('profiles.txt', 'r') 
   
    Lines = fprofiles.readlines() 
    for profile in Lines:
        ...
        print_credentials(username, password, profile_counter)
        comment = linecache.getline('comments.txt', profile_counter)
